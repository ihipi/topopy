...
def makePoint(X=0, Y=0, Z=0,name = "Point", code = "code", color=None, point_size= 5):
...
class _Point(_DraftObject):
    ...
    def __init__(self, obj,x=0,y=0,z=0,name='punt', code='codi'):
        _DraftObject.__init__(self,obj,name)
        obj.addProperty("App::PropertyString","Code","Base","Description").Code = code
